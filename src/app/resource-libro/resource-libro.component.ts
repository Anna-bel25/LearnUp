...
@Component({
  selector: 'app-resource-libro',
  standalone: true,
  imports: [ RouterLink, ResourceLibroComponent, ResourceMenuComponent, CommonModule, FormsModule, MatDialogModule ],
  templateUrl: './resource-libro.component.html',
  styleUrls: ['./resource-libro.component.css']
})
export class ResourceLibroComponent implements OnInit {
