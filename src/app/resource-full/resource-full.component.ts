...
@Component({
  ...
  standalone: true,
  imports: [ RouterLink, HomePageComponent, ResourceActividadComponent, ResourceVideoComponent, ResourceLibroComponent, CommonModule, FormsModule, MatDialogModule ],
