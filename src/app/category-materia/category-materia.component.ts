...
@Component({
  selector: 'app-category-materia',
  standalone: true,
  imports: [ RouterModule, ResourceMenuComponent, CommonModule ],
  templateUrl: './category-materia.component.html',
  styleUrl: './category-materia.component.css'
})
export class CategoryMateriaComponent implements OnInit {
